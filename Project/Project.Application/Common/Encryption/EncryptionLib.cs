...
namespace OnlineStore.Application.Common.Encryption
{
    public static class EncryptionLib
    {
        ...
        internal const string CookieSalt = "7Q8S2J3K5N6P7R9S2K4M5N7Q8R9S3K4M6P7Q8S2J3M5N6P7R9S2K4M5N7Q8R9T2J3";
        #endregion
        ...
        {
            return Encrypt(cookieValue, CookieSalt);
        }

        public static string DecryptCookie(string decyptedCookieValue)
        {
            return Decrypt(decyptedCookieValue, CookieSalt);
        }
